...
cp notion-viewer/infoview.css _out/site/html-multi/notion/infoview.css
cp notion-viewer/infoview.js _out/site/html-multi/notion/infoview.js
...
for old, new in repls:
    ...
    s = s.replace(old, new)
if 'infoview.css' not in s:
    s = s.replace('</head>', '<link rel="stylesheet" href="infoview.css">\n</head>', 1)
if 'infoview.js' not in s:
    s = s.replace('</body>', '<script src="infoview.js"></script>\n</body>', 1)
p.write_text(s)
PY
...
test -f _out/site/html-multi/notion/infoview.css
test -f _out/site/html-multi/notion/infoview.js
